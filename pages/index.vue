              ...
              <div>
                <div class="home_box_review">
                  <div class="detail_book">
                    <div class="home_title_reviewbook" @click="transformPages({ id: book.id, id_book: book.book_id })">
                      {{ book.title }}
                    </div>
                    by<span class="home_name_author"><a :href="book.author_link">{{ ' ' + book.author }}</a></span>
                    <div class="home_review_star">
                      <star-rating v-model="book.average_rating" :show-rating="false" :read-only="true" :increment="0.01"
                        :inline="true" :star-size="17" active-color="#e87400"></star-rating>
                  ...
                  <div class="home_info_author">
                    ...
                    <p v-else>
                      {{ book.description }}
                      <button class="more" @click="seeMorePrgh(index)" v-if="book.description.length > 200">
                        {{ checkMore(index) }}
                      </button>
                    </p>
                  </div>
